        ...
        return (
          <button
            ...
            className={`rounded-full hover:scale-105 2xl:hover:scale-110 hover:origin-bottom transition-all duration-200 ease-in-out
              ${isSelected
                ? 'bg-ungupink border-5 lg:border-8 2xl:border-10 scale-110 border-blueblack drop-shadow-[-1px_3px_0px_#0F1B24] lg:drop-shadow-[-2px_6px_0px_#0F1B24]  order-first'
          ...
          >
            <img
              src={char.icon}
              alt={char.name}
              className={`w-15 sm:w-30 m-1 lg:m-2 scale-250 shadow-[0_4px_8px_rgba(0,0,0,0)]`}
            />
          </button>
        );
      })}

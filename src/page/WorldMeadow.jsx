    ...
    <>
      <div className="flex flex-col w-full pt-50 bg-hijaubaru-reverse items-center justify-center">
        <div className="flex flex-col items-center gap-5">
          <h3 className="text-3xl text-white comic-relief-bold text-shadow-[-2px_4px_0px_#0F1B24]">Welcome to The Meadow</h3>
          <h1 className="text-6xl text-white uppercase text-shadow-[-2px_6px_0px_#0F1B24]">animal utopia</h1>
      ...
      <div className="flex flex-col w-full bg-hijaubaru-light items-center justify-center py-10 gap-10">
        ...
        <video className="w-full max-w-6xl h-150 rounded-4xl border-6 border-bs-blueblack shadow-[-10px_10px_25px_#000000]" controls>

export default function Footer() {
  return (
    <div className="w-full flex flex-col justify-content bg-green py-20 px-40 text-white relative z-50">
      <div className="flex">
        <div className="w-full lg:w-1/2 flex flex-col gap-8">
          <h1 className="text-2xl uppercase text-shadow-[-2px_3px_0px_#0F1B24]">SANGNILA INDONESIA — Developer & Publisher</h1>
          <p className="text-base comic-relief-bold uppercase">©2026 SANGNILA INDONESIA. <br className="block 2xl:hidden"/> All rights reserved.</p>
          <a href="https://www.sangnilaindonesia.com" target="_blank" rel="noopener noreferrer">
            <img src="/logo-sangnila.webp" alt="logo sangnila" className="w-30 2xl:w-40 drop-shadow-[-1px_3px_0px_#0F1B24]" />
          </a>
        </div>
        {/* Page list */}

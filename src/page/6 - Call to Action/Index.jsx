    ...
    <div className="relative w-full h-screen items-center flex justify-end pl-8 lg:pl-50 pr-8" id="cta-page">
      ...
      <div className="flex flex-col w-full lg:w-1/2 gap-5 relative z-5">
        <div className="flex flex-col gap-5">
          <h1 className="text-5xl text-white">join the fight</h1>
          <p className="text-lg 2xl:text-2xl text-white w-full poppins-regular">Add PAWPEWPEW to your Steam Wishlist now and get notified the exact moment the battle begins.</p>
        </div>

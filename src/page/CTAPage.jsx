...
export default function CTAPage() {
  return (
    <div className="relative w-full h-full py-10 lg:py-100 2xl:py-150 flex justify-end pl-8 2xl:pl-50 pr-8 bg-hijaubaru-light">
      ...
      <div className="flex flex-col w-full lg:w-1/2 gap-5 relative z-5">
        ...
        <div className="flex flex-col 2xl:flex-row gap-5">
          <CallToAction image={`/logo-steam.webp`} link="https://store.steampowered.com/app/4625080/Paw_Pew_Pew/">wishlist <br className="hidden 2xl:block" /> on steam</CallToAction>
          <CallToAction image={`/logo-kickstart.webp`}>back us on <br className="hidden 2xl:block" />kickstarter</CallToAction> 
          <CallToAction image={`/logo-discord.webp`} link="https://discord.gg/G27dAtVGSS">join our <br className="hidden 2xl:block" />discord</CallToAction>
        </div>

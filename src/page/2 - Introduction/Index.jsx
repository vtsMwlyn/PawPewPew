    ...
    <section className="w-full">
      ...
      <div className="w-full flex flex-col pt-10 lg:pt-30 bg-hijaubaru-reverse items-center justify-center">
        <div className="w-full flex flex-col items-center gap-5 px-8 2xl:p-0">
          ...
          comic-relief-bold text-shadow-[-1px_3px_0px_#0F1B24] lg:text-shadow-[-2px_4px_0px_#0F1B24]">
          ...
          <p className="text-white comic-relief-bold text-lg lg:text-2xl w-full lg:w-4xl 
              text-center text-shadow-[-1px_3px_0px_#0F1B24] lg:text-shadow-[-2px_4px_0px_#0F1B24]">
      ...
      <div className="w-full flex flex-col bg-hijaubaru-light items-center justify-center py-10 gap-6 px-8">
        ...
        <div className="relative w-full max-w-7xl lg:h-165 rounded-xl lg:rounded-4xl overflow-hidden bg-black">
          <video
            ref={videoRef}
            className="w-full h-full rounded-xl lg:rounded-4xl border-6 border-bs-blueblack shadow-[-10px_10px_25px_#000000] object-content lg:object-cover"
          ...
          <button
            ...
            className={`w-full h-full rounded-xl lg:rounded-4xl flex justify-center items-center bg-[rgba(0,0,0,0.8)] absolute top-0 transition ease-in-out duration-200 ${
              isPlaying
                ? 'opacity-0'
                : 'opacity-100'
            }`}

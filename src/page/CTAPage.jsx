...
export default function CTAPage() {
  return (
    <div className="relative w-full h-full py-150 pl-240">
      <img src="/bg-cta.png" alt="map" className="w-full object-cover absolute inset-0 -z-5 h-full w-full" />
      <div className="flex flex-col gap-10">
        <div className="flex flex-col gap-5">
          <h1 className="text-5xl font-bold text-white text-shadow-[-2px_6px_0px_#0F1B24]">ready to dominate?</h1>
          <p className="text-2xl text-white comic-relief-bold text-shadow-[-2px_4px_0px_#0F1B24]">Add Paw Pew Pew to your Steam Wishlist and be the first to know when the hunt begins</p>
        </div>
